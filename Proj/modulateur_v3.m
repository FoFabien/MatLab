...
clear all;
Fs = 1;
Nb = 10;     % Nb = 100 pour avoir la représentation en fréquence
M = 4;  % M = 16 pour pour la 16-QAM
T = 10;
N = Nb/log2(M);
D = 1/T;
Db = D * log2(M);
...
%Symboles = pammod(Symboles1,M);                  % Creation des symboles associés à cette suite
